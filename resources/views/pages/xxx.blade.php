...
@section('content')
    <div class="row">
        <div class="col-3 px-5" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked " id="myNav" style="position: sticky;top:120px">
        ...
        $(function () {
            ...
            $(window).scroll(function () {
                ...
                items.each(function (i, e) {
                    ...
                    if (windowHeight+top>itemTop){
                        m.addClass("tracking-in-expand");
                    }else {
                        m.removeClass("tracking-in-expand")
                    }
                })
            });
        })
