...
@section('content')
    <div class="row"> @include('shared._errors')</div>
    <div class="row">
        <div id="carouselExampleControls" class="carousel slide rol m-3" data-ride="carousel" style="width: 100%">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img onclick="alert(1)" src="/images/www.jpg" class="d-block w-100"  style="height: 100px;object-fit: fill" alt="...">
                </div>
            </div>
                        ...
                        <select-district inline-template @change="onDistrictChanged"
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-sm-3 input-group-sm">
                                    <select class="form-control  input-group-sm" v-model="provinceId" required>
                                ...
                                <div class="col-sm-3 input-group-sm">
                                    <select class="form-control   input-lg" v-model="districtId" required>
                        ...
                        <select-district inline-template @change="onDistrictChanged"
                            ...
                            <div class="form-row input-group-sm">
                                ...
                                <div class="col-sm-3 input-group-sm">
                                    ...
                                    @if ($errors->has('end_province'))
                                        <div class="invalid-feedback text-danger" style="display: block !important;">{{ $errors->first('end_province') }}</div>
                                    @endif
                                </div>
                                <div class="col-sm-3 input-group-sm">
                                    <select class="form-control" v-model="cityId" required>
