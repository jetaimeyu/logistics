    ...
    <div class="offset-md-2 col-md-8">
        <div class="card mt-5">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('users.store'), false); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" style="height: 40px;" class="form-control" id="captcha" name="captcha" value="<?php echo e(old('captcha'), false); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" style="height: 40px;" class="form-control" id="verificationCode" name="verificationCode" value="<?php echo e(old('verificationCode'), false); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" name="password" value="<?php echo e(old('password'), false); ?>">
                    </div>
                    <div class="form-group">
                        <label for="password_confirmation">重复密码</label>
                        <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" value="<?php echo e(old('password_confirmation'), false); ?>">
                    </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\www\logistics\resources\views/users/create.blade.php ENDPATH**/ ?>